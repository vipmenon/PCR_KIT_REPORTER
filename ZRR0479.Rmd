...
**上海之江生物2019-nCoV检测试剂盒 QuantStudioDx PCR实验结果Excel数据数据分析**

[使用说明书下载](www/Z-RR-0479-02_User_manual.pdf)
...
expNum2speNum <- function(expNum) {
  ...
  if (tolower(expNum) == 'p') return('p')
  if (tolower(expNum) == 'n') return('n')
