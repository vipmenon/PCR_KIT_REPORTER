...
report_template_pos <- list(Liferiver_p = "report/nCoV_template8.docx",
                            ...
                            Biogerm_p = "report/nCoV_template9z.docx")
...
selectInput("tester", label = "检测员", choices = userNames, selected = 882287)

selectInput("checker", label = "审核员", choices = userNames, selected = 366169)
